...
class TDSnackBar extends StatefulWidget {
  ...
  @override
  State<TDSnackBar> createState() => _TDSnackBarState();
}

class _TDSnackBarState extends State<TDSnackBar> {
  @override
